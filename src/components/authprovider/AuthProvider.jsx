...
import { MetaMask, uauth } from './connectors';
...
const AuthProvider = ({ children }, props) => {
  ...
  const { connector, library, chainId, account, activate, deactivate, error } =
    context;
  ...
  const loginConnectors = [
    ...
    },
    {
      ...
      logo: '/assets/images/unstoppable.webp',
      is_popular: false,
      connectorFunction: uauth,
    },
  ];
